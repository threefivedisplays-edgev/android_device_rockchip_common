...
#    $(info device-rockchip-common TARGET_DEVICE_DIR: $(TARGET_DEVICE_DIR))
    $(shell python $(LOCAL_PATH)/auto_generator.py device/rockchip/rk3399 preinstall bundled_persist-app)
    $(shell python $(LOCAL_PATH)/auto_generator.py device/rockchip/rk3399 preinstall_del bundled_uninstall_back-app)
    $(shell python $(LOCAL_PATH)/auto_generator.py device/rockchip/rk3399 preinstall_del_forever bundled_uninstall_gone-app)
